  ...
  final List<Map<String, dynamic>> questions = [
    ...
    // },
    {
      ...
      "dialogs": {
        ...
        8: "Mais non",
        9: "",
        10: "Loredan est une ouff",
      },
      "options": {
        3: ["Juan", "Lavar, the boss man", "Devonte"],
        6: ["2", "6", "1", "5"],
        7: ["Kayla", "Kainah", "Gnilane"],
        9: ["Sama Xol", "Sama Kër", "Sama Jekkër"],
      },
      "sentencesToCompleteIndex": [3, 6, 7, 9],
      "questions": ["Who is the mail man ?", "How many children does she have ?", "What is her name ?", ""],
      "answers": ["Lavar, the boss man", "5", "Kayla", "Sama Kër"],
      "questionsType": ['checkbox', 'checkbox', 'checkbox', 'option'],
